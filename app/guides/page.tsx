...
const allGuides = [
  {
    ...
    rating: 4.9,
    reviews: 156,
    bio: "Expert in Northern Areas hiking and mountaineering with 15+ years experience",
    image: "/pakistani-tour-guide-professional-male.jpg",
    locations: ["Northern Areas", "Hunza Valley", "Skardu"],
  ...
  },
  {
    ...
    locations: ["Lahore", "Islamabad", "Peshawar"],
  ...
  },
  {
    ...
    locations: ["Karachi", "Balochistan", "Sindh"],
  ...
  },
  {
    ...
    locations: ["Hunza Valley", "Nagar", "Altit"],
  ...
  },
  {
    ...
    locations: ["Fairy Meadows", "Deosai", "Skardu"],
  ...
  },
  {
    ...
    locations: ["Swat Valley", "Naran", "Abbottabad"],
    languages: ["Urdu", "English"],
    experience: 11,
    verified: true,
    responseTime: "1 hour",
  ...
  },
  {
    ...
    locations: ["Cholistan Desert", "Balochistan", "Multan"],
  ...
  },
  {
    ...
    locations: ["Khunjerab", "Attabad Lake", "Shandur Pass"],
    languages: ["Urdu", "English"],
    experience: 16,
    verified: true,
    responseTime: "2 hours",
