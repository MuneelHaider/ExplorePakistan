...
const activities = [
  {
    ...
    icon: "⛰️",
    locations: ["Northern Areas", "Hunza Valley", "Swat Valley"],
  },
  {
    id: 2,
    name: "Cultural Tours",
  ...
  },
  {
    ...
    icon: "🧗",
    locations: ["Karachi", "Hunza Valley", "Swat Valley"],
  },
  {
    id: 4,
    ...
    icon: "📸",
    locations: ["Fairy Meadows", "Naran", "Deosai"],
  },
  {
    id: 5,
    name: "Desert Safaris",
    ...
    icon: "🏜️",
    locations: ["Cholistan Desert", "Multan", "Balochistan"],
  },
  {
    id: 6,
    ...
    icon: "🦅",
    locations: ["Khunjerab", "Attabad Lake", "Sharan Forest"],
  },
]
